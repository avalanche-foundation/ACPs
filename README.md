...
ACPs are public documents. If an author wishes to maintain the confidentiality of an idea, or wishes to retain intellectual property rights in an idea, the author should not publicize that idea in an ACP or as a precursor to an ACP. 

No actions or omissions done in connection with a specific ACP or the ACP program/process creates any form of legal entity, partnership, unincorporated business association, DAO or any other type of affiliation that would cause participants to have liability for another person's actions or omissions. 

Neither Ava Labs, Inc. or the Avalanche Foundation Limited is party to any ACP, nor is it the creator of the ACP program/process. Ava Labs, Inc. and the Avalanche Foundation Limited each expressly disclaims responsibility for and liabilities resulting from, any information or communication from and between members of the Avalanche Community regarding any ACP. 