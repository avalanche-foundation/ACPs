...
|[125](./ACPs/125-basefee-reduction/README.md)|Reduce C-Chain minimum base fee from to 1 nAVAX|Stephen Buttolph (https://github.com/StephenButtolph), Darioush Jalali (https://github.com/darioush)|Standards|
